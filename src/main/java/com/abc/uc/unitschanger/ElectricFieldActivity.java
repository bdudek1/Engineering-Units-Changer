...
public class ElectricFieldActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rb[0].setText("volt/meter [V/m]");

        rb[1] = new RadioButton(this);
        rb[1].setText("volt/inch [V/in]");

        rb[2] = new RadioButton(this);
        rb[2].setText("kilovolt/meter [kV/m]");

        rb[3] = new RadioButton(this);
        rb[3].setText("kilovolt/inch [kV/in]");

        rb[4] = new RadioButton(this);
        rb[4].setText("abvolt/centimeter [abV/cm]");

        rb[5] = new RadioButton(this);
        rb[5].setText("statvolt/centimeter [statV/cm]");

        rb[6] = new RadioButton(this);
        rb[6].setText("statvolt/inch [statV/in]");

        rb[7] = new RadioButton(this);
        rb[7].setText("newton/columb [N/C]");
        ...
        rb2[0].setText("volt/meter [V/m]");

        rb2[1] = new RadioButton(this);
        rb2[1].setText("volt/inch [V/in]");

        rb2[2] = new RadioButton(this);
        rb2[2].setText("kilovolt/meter [kV/m]");

        rb2[3] = new RadioButton(this);
        rb2[3].setText("kilovolt/inch [kV/in]");

        rb2[4] = new RadioButton(this);
        rb2[4].setText("abvolt/centimeter [abV/cm]");

        rb2[5] = new RadioButton(this);
        rb2[5].setText("statvolt/centimeter [statV/cm]");

        rb2[6] = new RadioButton(this);
        rb2[6].setText("statvolt/inch [statV/in]");

        rb2[7] = new RadioButton(this);
        rb2[7].setText("newton/columb [N/C]");
        ...
        convert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rb[4].isChecked()) {
                    calc1 = 0.000001;
                    str1 = "abvolt/centimeter";
                    isChecked1 = true;
                }
                if (rb[5].isChecked()) {
                    calc1 =  29979.2;
                    str1 = "statvolt/centimeter";
                    isChecked1 = true;
                }
                if (rb[6].isChecked()) {
                    calc1 = 11802.835;
                ...
                if (rb2[4].isChecked()) {
                    calc2 = 0.000001;
                    str2 = "abvolt/centimeter";
                    isChecked2 = true;
                }
                if (rb2[5].isChecked()) {
                    calc2 = 29979.2;
                    str2 = "statvolt/centimeter";
                    isChecked2 = true;
                }
                if (rb2[6].isChecked()) {
                    calc2 = 11802.835;
                ...
                if(isChecked1 == true && isChecked2 == true && isEmpty(editText) == false) {
                    ...
                    Toast.makeText(ElectricFieldActivity.this,
        ...
        textView.setText("Electric field unit converter");
        ...
        textSI.setText(Html.fromHtml("SI unit of electric field = [N*C<sup>-1</sup>]"));
