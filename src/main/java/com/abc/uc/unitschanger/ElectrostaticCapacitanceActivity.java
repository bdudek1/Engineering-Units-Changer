...
public class ElectrostaticCapacitanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rb[0].setText("farad [F]");

        rb[1] = new RadioButton(this);
        rb[1].setText("milifarad [mF]");

        rb[2] = new RadioButton(this);
        rb[2].setText("kilofarad [kF]");

        rb[3] = new RadioButton(this);
        rb[3].setText("coulomb/volt [C/V]");

        rb[4] = new RadioButton(this);
        rb[4].setText("abfarad [abF]");

        rb[5] = new RadioButton(this);
        rb[5].setText("EMU of capacitance");
        ...
        rb2[0].setText("farad [F]");

        rb2[1] = new RadioButton(this);
        rb2[1].setText("milifarad [mF]");

        rb2[2] = new RadioButton(this);
        rb2[2].setText("kilofarad [kF]");

        rb2[3] = new RadioButton(this);
        rb2[3].setText("coulumb/volt [C/V]");

        rb2[4] = new RadioButton(this);
        rb2[4].setText("abfarad [abF]");

        rb2[5] = new RadioButton(this);
        rb2[5].setText("EMU of capacitance");
        ...
        convert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isChecked1 == true && isChecked2 == true && isEmpty(editText) == false) {
                    ...
                    Toast.makeText(ElectrostaticCapacitanceActivity.this,
        ...
        textView.setText("Electrostatic capacitance unit converter");
        ...
        textSI.setText(Html.fromHtml("SI unit of electrostatic capacitance = [A<sup>2</sup>*s<sup>4</sup>*kg<sup>-1</sup>*m<sup>-2</sup>]"));
