...
public class ForceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rb[0].setText("newton [N]");

        rb[1] = new RadioButton(this);
        rb[1].setText("kilogram-force [kgf]");

        rb[2] = new RadioButton(this);
        rb[2].setText("gram-force [gf]");

        rb[3] = new RadioButton(this);
        rb[3].setText("dyne [dyn]");

        rb[4] = new RadioButton(this);
        rb[4].setText("joule/meter [J/m]");

        rb[5] = new RadioButton(this);
        rb[5].setText("joule/centimeter [J/cm]");

        rb[6] = new RadioButton(this);
        rb[6].setText("pound-force [lbf]");
        ...
        rb2[0].setText("newton [N]");

        rb2[1] = new RadioButton(this);
        rb2[1].setText("kilogram-force [kgf]");

        rb2[2] = new RadioButton(this);
        rb2[2].setText("gram-force [gf]");

        rb2[3] = new RadioButton(this);
        rb2[3].setText("dyne [dyn]");

        rb2[4] = new RadioButton(this);
        rb2[4].setText("joule/meter [J/m]");

        rb2[5] = new RadioButton(this);
        rb2[5].setText("joule/centimeter [J/cm");

        rb2[6] = new RadioButton(this);
        rb2[6].setText("pound-force [lbf]");

        rb2[7] = new RadioButton(this);
        rb2[7].setText("pond [p]");
        ...
        convert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isChecked1 == true && isChecked2 == true && isEmpty(editText) == false) {
                    ...
                    Toast.makeText(ForceActivity.this,
        ...
        textView.setText("Force unit converter");
        ...
        textSI.setText(Html.fromHtml("SI unit of force = [kg*m*s<sup>-2</sup>]"));
