...
public class FrequencyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rb[0].setText("milihertz [mHz]");

        rb[1] = new RadioButton(this);
        rb[1].setText("hertz [Hz]");

        rb[2] = new RadioButton(this);
        rb[2].setText("kilohertz [kHz]");

        rb[3] = new RadioButton(this);
        rb[3].setText("megahertz [MHz]");
        ...
        rb2[0].setText("milihertz [mHz]");

        rb2[1] = new RadioButton(this);
        rb2[1].setText("hertz [Hz]");

        rb2[2] = new RadioButton(this);
        rb2[2].setText("kilohertz [kHz]");

        rb2[3] = new RadioButton(this);
        rb2[3].setText("megahertz [MHz]");
        ...
        convert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isChecked1 == true && isChecked2 == true && isEmpty(editText) == false) {
                    ...
                    Toast.makeText(FrequencyActivity.this,
        ...
        textView.setText("Frequency unit converter");
        ...
        textSI.setText(Html.fromHtml("SI unit of frequency = [s<sup>-1</sup>]"));
