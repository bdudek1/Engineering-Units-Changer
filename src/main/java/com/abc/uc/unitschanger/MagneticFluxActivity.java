...
public class MagneticFluxActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rb[0].setText("weber [Wb]");

        rb[1] = new RadioButton(this);
        rb[1].setText("volt-second [V*s]");

        rb[2] = new RadioButton(this);
        rb[2].setText(Html.fromHtml("tesla square meter [T*m<sup>2</sup>]"));

        rb[3] = new RadioButton(this);
        rb[3].setText("maxwell [Mw]");

        rb[4] = new RadioButton(this);
        rb[4].setText(Html.fromHtml("gauss square centimeter [G*cm<sup>2</sup>]"));
        ...
        rb2[0].setText("weber [Wb]");

        rb2[1] = new RadioButton(this);
        rb2[1].setText("volt-second [V*s]");

        rb2[2] = new RadioButton(this);
        rb2[2].setText(Html.fromHtml("tesla square meter [T*m<sup>2</sup>]"));

        rb2[3] = new RadioButton(this);
        rb2[3].setText("maxwell [Mw]");

        rb2[4] = new RadioButton(this);
        rb2[4].setText(Html.fromHtml("gauss square centimeter [G*cm<sup>2</sup>]"));
        ...
        convert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isChecked1 == true && isChecked2 == true && isEmpty(editText) == false) {
                    ...
                    Toast.makeText(MagneticFluxActivity.this,
        ...
        textView.setText("Magnetic flux unit converter");
        ...
        textSI.setText("SI unit of magnetic flux = [V*s]");
