...
public class MolarConcentrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView textmolarConcentration = new TextView(this);
        ...
        convert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isEmpty(editText)== false && isEmpty(editText2)== false && isEmpty(editText3)== false) {
                    double a = Double.parseDouble(editText.getText().toString());
                    double b = Double.parseDouble(editText2.getText().toString());
                    double ro = Double.parseDouble(editText3.getText().toString());
                    v1 = a + b;
                    c1 = b / v1 * 100;
                    double cm1 = c1 * ro / (atMa * 100);
                    ...
                    textmolarConcentration.setText(Html.fromHtml("Molar concetration = " + String.format("%1.4f", cm1) + " [mol/dm<sup>3</sup>]"));
                    textmolarConcentration.setTextSize(15);
                    textmolarConcentration.setLayoutParams(params);
                }else{
                    Toast.makeText(MolarConcentrationActivity.this,
        ...
        textView5.setText(Html.fromHtml("Enter density of mixing [g/cm<sup>3</sup>] = "));
        ...
        linearLayout.addView(textmolarConcentration);
