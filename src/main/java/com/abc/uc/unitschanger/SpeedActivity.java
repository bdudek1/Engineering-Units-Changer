...
public class SpeedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rb[0].setText("meter/second [m/s]");

        rb[1] = new RadioButton(this);
        rb[1].setText("kilometer/hour [km/h]");

        rb[2] = new RadioButton(this);
        rb[2].setText("mile/hour [mi/h]");

        rb[3] = new RadioButton(this);
        rb[3].setText("knot [kn]");

        rb[4] = new RadioButton(this);
        rb[4].setText("foot/second [ft/s]");
        ...
        rb2[0].setText("meter/second [m/s]");

        rb2[1] = new RadioButton(this);
        rb2[1].setText("kilometer/hour [km/h]");

        rb2[2] = new RadioButton(this);
        rb2[2].setText("mile/hour [mi/h]");

        rb2[3] = new RadioButton(this);
        rb2[3].setText("knot [kn]");

        rb2[4] = new RadioButton(this);
        rb2[4].setText("foot/second [ft/s]");
        ...
        convert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isChecked1 == true && isChecked2 == true && isEmpty(editText) == false) {
                    ...
                    Toast.makeText(SpeedActivity.this,
        ...
        textView.setText("Speed unit converter");
        ...
        textSI.setText(Html.fromHtml("The SI unit of speed = [m*s<sup>-1</sup>]"));
