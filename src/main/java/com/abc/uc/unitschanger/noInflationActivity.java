...
public class noInflationActivity extends AppCompatActivity {
        ...
        convert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isEmpty(editText) == false && isEmpty(editText2) == false && isEmpty(editText3) == false) {
                    ...
                    percent = Double.parseDouble(editText2.getText().toString());
                    ...
                    Toast.makeText(noInflationActivity.this,
